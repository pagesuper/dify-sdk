...
var fastestsmallesttextencoderdecoder_1 = require("fastestsmallesttextencoderdecoder");
exports.MIME_MAP = {
    // 文档类型
    document: {
        mimeTypes: [
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        ...
                        // 将Buffer转换为字符串
                        buffer += new fastestsmallesttextencoderdecoder_1.TextDecoder().decode(value, { stream: true });
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        ...
                        buffer_1 += new fastestsmallesttextencoderdecoder_1.TextDecoder().decode(value);
                        processBuffer();
                        return [3 /*break*/, 4];
